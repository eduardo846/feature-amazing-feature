...
async function authenticate(request: NextRequest): Promise<AuthPayload | { error: string; status: number }> {
...
function isAuth(auth: Awaited<ReturnType<typeof authenticate>>): auth is AuthPayload {
